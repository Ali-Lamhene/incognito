...
- Les défis sont attribués au début de la partie lors du `startMission`.
- Une fois le dossier déverrouillé, les défis s'affichent sous forme de **carousel horizontal**.
- Le joueur glisse vers la droite (Swipe Right) pour afficher le défi suivant, et vers la gauche (Swipe Left) pour revenir au précédent.
